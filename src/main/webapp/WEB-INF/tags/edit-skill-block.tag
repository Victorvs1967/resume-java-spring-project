...
<%@ attribute name="skill" required="false" type="com.vvs.resume.entity.Skill"%>

<div id="ui-item-${index }" class="row ui-item skill-item mb-4">
	...
	<div class="col-xs-7 col-sm-8 col-md-10 value-container mt-n4">
...
<div class="row skill-delim" >
	<div class="col-xs-offset-5 col-sm-offset-4 col-md-offset-2 col-xs-7 col-sm-8 col-md-10">
